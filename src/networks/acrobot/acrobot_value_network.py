...
class AcrobotValueNetwork:
    """
    Implements a value network for the Acrobot environment using TensorFlow 1.x.
    """
    ...
    def save_weights(self, sess):
        ...
        :param sess: TensorFlow session used for running the operations.
        """
        weights = {
        ...
        with open(config.acrobot_value_weights, 'w') as f:
            json.dump(weights, f)
