...
class MccValueNetwork:
    """
    Implements a value network for the MountainCarContinuous environment using TensorFlow 1.x.
    """
    ...
    def __init__(self, learning_rate, name='value_network'):
        ...
        self.size_first_hidden_layer = config.mcc_value_hidden_1_size
        self.size_second_hidden_layer = config.mcc_value_hidden_2_size
    ...
    def save_weights(self, sess):
        ...
        with open(config.mcc_value_weights, 'w') as f:
            json.dump(weights, f)
